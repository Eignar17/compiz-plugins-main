...
static void animHandleEvent(CompDisplay * d, XEvent * event)
{
	...
	if (!winOpenedClosed)
	{
	    ...
	    saveRestackInfo (w, clientListStacking, n);
	}
	updateLastClientListStacking(s);
    }
    break;
...
AnimEngine AnimEngineTransform = &(AnimEngine)
    {"animation:engineTransform",
     {.prePaintOutputFunc      = engTransformPrePaintOutput,
      .postPaintOutputFunc     = engTransformPostPaintOutput,
      .prePaintWindowFunc      = engTransformPrePaintWindow,
      .postPaintWindowFunc     = engTransformPostPaintWindow
     }
    }

AnimEngine AnimEngineAttrib = &(AnimEngine)
    {"animation:engineAttrib",
     {.prePaintOutputFunc      = engAttribPrePaintOutput,
      .postPaintOutputFunc     = engAttribPostPaintOutput,
      .prePaintWindowFunc      = engAttribPrePaintWindow,
      .postPaintWindowFunc     = engAttribPostPaintWindow     
    }

AnimEngine AnimEngineTransform = &(AnimEngine)
    {"animation:engineModel",
     {.prePaintOutputFunc      = engModelPrePaintOutput,
      .postPaintOutputFunc     = engModelPostPaintOutput,
      .prePaintWindowFunc      = engModelPrePaintWindow,
      .postPaintWindowFunc     = engModelPostPaintWindow,
      .preHandleEventFunc      = engModelPreHandleEvent,
      .postHandleEventFunc     = engModelPostHandleEvent,
      .moveNotifyFunc          = engModelMoveNotify,
      .resizeNotifyFunc        = engModelResizeNotify
     }
    }

AnimEngine AnimEngineRestacker = &(AnimEngine
    {"animation:engineRestacker",
     {.preHandleEventFunc      = engRestackPreHandleEvent,
      .postHandleEventFunc     = engRestackPostHandleEvent,

AnimEngine animEgnines[NUM_ENGINES];
